...
# MASTER REVENUE PARTICIPATION AGREEMENT  

This Master Revenue Participation Agreement (the “Agreement”) is entered into on [● Effective Date] (the “Effective Date”) by and between:

**MonTech UBO**, a company incorporated under the laws of Lithuania, with registered address at [●] (the “Company”)  

and  

**YOUSEF JIAN**, holder of residence permit / ID number DK2094876, born 30.03.1988, nationality Syrian (the “Partner”)

The Company and the Partner are each a “Party” and together the “Parties”.

---

## 1. REVENUE PARTICIPATION
1.1 The Company shall pay the Partner 15% of Final Net Revenue generated by MonCash.  
1.2 Total aggregate liability under this Agreement shall not exceed EUR 1,000,000 (the “Cap”).  
1.3 Term shall not exceed 36 months from the Effective Date.  
1.4 Payments are strictly performance-based and contingent on Net Revenue generation.  

---

## 2. GROSS REVENUE RECOGNITION
Gross Revenue includes all amounts actually settled and received by the Company from MonCash customers, including:
- transaction fees  
- subscription income  
- interchange revenue  
- FX margin income  
...
Revenue is recognized strictly on settlement basis only, excluding:
- pending transactions  
- authorized but not settled transactions  
...
**Gross Revenue minus Permitted Deductions**

Permitted Deductions include:
(a) EMI, banking, acquiring, and processing fees  
(b) card scheme fees  
(c) fraud losses, chargebacks, refunds, disputes  
(d) fraud reserve adjustments  
(e) directly attributable operational costs of MonCash  
(f) MonCore Allocation Fee (Schedule 2)  

---

## 4. FINAL NET REVENUE RULE (AUDIT FINALITY DOCTRINE)
4.1 “Final Net Revenue” means Net Revenue after month-end reconciliation under Schedule 1.  
4.2 Final Net Revenue shall be final, binding, and contractually closed unless disputed within 30 calendar days (“True-Up Window”).  
4.3 If not disputed within the True-Up Window, statements are deemed irrevocably accepted.  
4.4 Post-period adjustments may apply only for chargebacks, fraud, or regulatory corrections.  
4.5 In case of conflict between ledgers, EMI settlement ledger prevails absolutely.  

---

## 5. ACCOUNTING POLICY, FINALITY & DATA GOVERNANCE

### 5.1 IFRS / GAAP APPLICATION
IFRS or applicable Lithuanian GAAP shall be applied consistently.

### 5.2 ORDER OF PRECEDENCE
(a) EMI / banking settlement ledger (final authority)  
(b) core ledger  
(c) internal reporting system  

### 5.3 METHODOLOGY CHANGES
- required by law or auditor only  
- applied prospectively only  
- documented and disclosed  

### 5.4 NON-RELIANCE CLAUSE
Partner acknowledges it does not rely on internal models except contractually defined systems.  

---

### 5.5 FINALITY OF FINANCIAL STATEMENTS (LEGAL CLOSURE RULE)
(a) All monthly financial statements become final, binding, and contractually closed upon expiry of the True-Up Window.  
(b) If not disputed, Partner is deemed to have irrevocably accepted full correctness.  
(c) No reopening except:
- proven fraud  
- manifest computational error  
- regulatory/statutory requirement  
(d) Final statements override internal systems, models, or reporting tools.  

---

### 5.6 INDEPENDENT VERIFIABILITY STANDARD
All financial determinations must be:
- traceable to objective EMI/banking data  
- not solely dependent on unilateral internal methodology  
- internally generated systems are supporting evidence only  

---

### 5.7 DATA AND RELIANCE HIERARCHY
In case of conflict:
1. EMI / banking settlement systems  
2. card scheme confirmations  
3. core ledger  
4. internal reporting  

Partner expressly acknowledges non-reliance on internal projections or dashboards.  

---

## 6. MONCORE ALLOCATION (TRANSFER PRICING FRAMEWORK)

6.1 Internal cost attribution mechanism for MonCore infrastructure.  

6.2 Allocation shall:
- be based on defined cost pools  
- follow OECD arm’s length principles  
- be applied in good faith and commercially reasonable manner  
- be independently verifiable  

6.3 ANTI-DISCRETION PRICING FIREWALL  
Allocation shall not:
- artificially reduce Net Revenue  
- distort profitability  
- deviate from market benchmarks  
- be non-auditable  

6.4 No retrospective changes; prospective only.  
6.5 Final unless manifest error exists.  

---

### 6.6 GOVERNANCE LIMITATION ON DISCRETION
All discretion shall be:
- commercially reasonable  
- in good faith  
- audit-reproducible  
- non-arbitrary  

No discretion may distort Net Revenue or Partner entitlement.  

---

### 6.7 ECONOMIC NEUTRALITY TEST
All allocations must:
(a) comply with OECD arm’s length principles  
(b) not be designed to reduce distributable Net Revenue  
(c) be benchmarkable against external market standards  

Independent expert may override internal methodology.  

---

## 7. PAYMENT TERMS
Monthly payments within [●] Business Days after reconciliation.  
Payments based exclusively on Final Net Revenue.  
Bank transfer to nominated account.  

---

## 8. TAXATION AND WITHHOLDING
Each Party bears its own tax obligations.  
Withholding applies where legally required.  
Such withholding constitutes full settlement.  

---

## 9. NON-TRANSFERABILITY
No assignment, pledge, securitisation without written consent. Void if attempted.  

---

## 10. REGULATORY DEPENDENCY
Payments may be suspended or adjusted due to:
- EMI requirements  
- AML/CTF obligations  
- sanctions  
- card scheme rules  
...
No breach arises from such actions.  
...
Obligations suspended during such events.  

---

## 12. TERMINATION
Immediate termination for fraud, breach, regulatory or operational risk.  
Either Party may terminate with [●] notice.  
Only accrued Final Net Revenue remains payable.  

---

## 13. CLAWBACK AND SET-OFF (LIMITED & CONTROLLED)

13.1 Allowed for overpayments, fraud, chargebacks, audit corrections.  

13.2 Limited to:
- 24-month lookback  
- AND >1% materiality threshold unless fraud  

13.3 Fraud = intentional manipulation or knowingly false reporting.  

13.4 Disputed amounts are suspended (not offset) pending resolution.  

---

### 13.5 CLAWBACK PROCEDURAL PROTECTION
(a) Must include written notice with:
- calculation basis  
- affected period  
- supporting data  

(b) Disputed amounts:
- placed in suspension account  
- not offset automatically  
- subject to dispute resolution  

(c) Must be classified as:
- error correction  
- fraud remediation  
- accounting true-up  
...
## 14. CONFIDENTIALITY
All information remains strictly confidential indefinitely.  

---

## 15. LIMITATION OF LIABILITY
Strictly limited to unpaid Final Net Revenue.  
No indirect or consequential damages.  

---

## 16. DISPUTE RESOLUTION (STRICT BANK-GRADE FRAMEWORK)

16.1 Internal reconciliation: 15–30 days  

16.2 Independent Expert Phase:
- EU-licensed auditor or Big4-equivalent  
- binding on calculation matters only  

### 16.2A LEGAL OPINION LAYER (EXTERNAL COUNSEL VALIDATION CLAUSE)
Each Party may obtain an independent legal opinion from a qualified EU-licensed law firm (including but not limited to Linklaters, Clifford Chance, Allen & Overy, or equivalent national firms). Such opinion shall be admissible as persuasive authority in any dispute but shall not override contractual provisions unless mutually agreed.

### 16.2B REGULATORY PERIMETER CONFIRMATION CLAUSE
The Parties acknowledge that the interpretation of this Agreement may be confirmed by a licensed EMI / payment institution or regulated financial services entity, whose regulatory classification shall be treated as authoritative regarding perimeter compliance.

### 16.2C DEFINED AUDIT STANDARD (BIG4 NAMED + JURISDICTION BINDING)
All audits shall be performed under IFRS and ISA standards by one of the following firms: Deloitte, PwC, EY, or KPMG, within an EU jurisdiction mutually agreed. Audit conclusions shall be binding for financial calculation purposes.

---

16.3 Arbitration:
- ICC Arbitration Rules (exclusive)  
- Seat: Paris, France (non-optional)  
- Language: English  
- Final and binding  

16.4 No unilateral forum selection allowed.  

---

### 16.5 ARBITRATION FINAL STRUCTURE (NO AMBIGUITY RULE)
(a) ICC exclusive arbitration applies  
(b) Seat: Paris, France  
(c) 3 arbitrators unless agreed otherwise  
(d) Covers:
- valuation  
- allocation  
- accounting interpretation  
- revenue calculation  
(e) Experts decide math; tribunal decides law  
...
### 17.1 EU MANDATORY LAW OVERRIDE HIERARCHY
Notwithstanding any contractual provision, EU mandatory law, EU regulations, and applicable financial services directives shall prevail over this Agreement in case of conflict. Any clause contrary to mandatory EU law shall be deemed modified to the minimum extent necessary for compliance.

---

### 17.2 REGULATORY CLASSIFICATION FIREWALL
This Agreement:
- is a commercial revenue participation arrangement  
- is not a security, equity, debt, deposit, or investment product  
- is not within MiFID regulated instrument scope  
- grants no ownership or fiduciary rights  

---

### 17.3 NO CONSTRUCTIVE TRUST / NO FIDUCIARY INTERPRETATION
The Parties expressly agree that no constructive trust, fiduciary duty, agency relationship, or equitable ownership interest shall arise under or in connection with this Agreement, whether by operation of law or otherwise.
...
## 19. AMENDMENTS
Only valid if written and signed by both Parties.  

---

## 20. SCHEDULES
All Schedules form integral part of this Agreement.  

---

## STRUCTURE & LEGAL CLASSIFICATION

21.1 MonCore is internal infrastructure of the Company.  
21.2 MonCash is an application layer built on MonCore.  
21.3 MonCore has no profit entitlement.  
21.4 This Agreement applies only to MonCash Net Revenue.  
21.5 No rights in MonCore or infrastructure.  
21.6 Not equity, debt, partnership, or fiduciary relationship.  

---

## PURPOSE & SCOPE

22.1 Sole purpose: MonCash revenue participation.  
22.2 No rights in:
- MonCore infrastructure  
- EMI accounts  
- customer funds  
...
## 21. LEGAL STATUS, RING-FENCING & ECONOMIC SEPARATION (UPGRADED)

21.7 NO ECONOMIC OWNERSHIP DOCTRINE  
The Partner expressly acknowledges that:
this Agreement creates no ownership, equity, or profit participation rights  
Partner has no claim over Company valuation, exit value, or goodwill  
entitlement is strictly limited to contractual Net Revenue calculation  

21.8 NON-PARTNERSHIP & NON-JOINT VENTURE CLAUSE  
...
21.9 RING-FENCING OF MONCORE & MONCASH  
MonCore and MonCash are legally and economically segregated:
MonCore = internal infrastructure cost center only  
MonCash = revenue-generating product layer only  
Partner has no rights, direct or indirect, in MonCore valuation or economics  

---

## 22. REGULATORY & FINANCIAL SERVICES CLASSIFICATION (EMI-GRADE FIREWALL)

22.3 PSD2 / E-MONEY REGULATORY POSITIONING  
This Agreement is intended to be interpreted as:
a commercial revenue participation contract  
not a payment service agreement with customer fund entitlement  
not issuance of electronic money  
not custody or safeguarding arrangement  

22.4 MiFID II EXCLUSION CLAUSE (EXPANDED)  
This Agreement is explicitly structured to fall outside:
MiFID II financial instruments classification  
collective investment schemes  
transferable securities definitions  

22.5 NO DEPOSIT / NO CLIENT FUNDS EXPOSURE  
The Partner:
has no claim on safeguarded funds  
has no exposure to customer balances  
has no deposit-like entitlement  

---

## 23. INSOLVENCY & CREDITOR PRIORITY (CRITICAL BANK GAP FIXED)

23.1 SUBORDINATION OF CLAIMS  
All Partner entitlements under this Agreement shall be:
contractually subordinated to all secured and unsecured creditors  
not treated as debt obligation  
not payable in priority during insolvency proceedings except where legally mandatory  

23.2 INSOLVENCY EVENT HANDLING  
In case of insolvency:
unpaid revenue shares convert into non-preferred contractual claims  
no acceleration of future revenue rights occurs  
only already-finalized Net Revenue is considered payable  

---

## 24. INDEMNITY & LIABILITY SHIFT (BANK STANDARD ADDITION)

24.1 PARTNER INDEMNITY  
The Partner shall indemnify the Company against:
fraud or misrepresentation  
regulatory breach caused by Partner actions  
tax liabilities arising from Partner structure  

24.2 COMPANY INDEMNITY LIMITATION  
Company indemnity is strictly limited to:
proven non-payment of Final Net Revenue only  

---

## 25. CONTRACTUAL INTERPRETATION LOCK (CRITICAL ENFORCEABILITY LAYER)

25.1 NO IMPLIED REVENUE RIGHTS  
No term shall be interpreted to:
expand Partner economic entitlement  
create implied profit participation  
extend beyond Net Revenue formula definition  

25.2 COMMERCIAL PURPOSE OVERRIDE RULE  
If interpretation conflict arises:
commercial intent = strict revenue formula enforcement, not economic sharing expansion  

---

## 26. AUDIT STANDARDIZATION (BIG4-GRADE FIX)

26.1 AUDIT STANDARD  
All audits shall be conducted under:
IFRS accounting standards  
ISA (International Standards on Auditing)  

26.2 AUDIT LIMITATION  
Audit shall NOT:
re-evaluate commercial pricing policy  
override contractual allocation rules  
reinterpret economic intent  

---

## 27. DISPUTE ENFORCEMENT (NY CONVENTION HARDENING)

27.6 ENFORCEMENT CLAUSE  
Any arbitral award shall be enforceable under:
...
emergency arbitration measures  
without breaching this Agreement.  

---

## 28. ECONOMIC SUBSTANCE NON-RECHARACTERIZATION CLAUSE  
No tax authority, regulator, or court shall recharacterize this Agreement as:
equity instrument  
loan  
collective investment scheme  
deposit structure  
unless mandatory law overrides.  

---

## SIGNATURES (FINAL SECTION ONLY)

For MonTech UBO  
Name: Mon Petrisor Florin 
Title: Founder / Athorized Signatory  
Signature: ________________  
Date: _____________________  
